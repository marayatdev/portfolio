  ...
  const projects = [
    {
      ...
      image: "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8MTJ8fGVjb21tZXJjZXxlbnwwfHx8fDE2OTMzNDAxNzl8MA&ixlib=rb-4.0.3&q=80&w=500",
      githubUrl: "#",
      liveUrl: "#"
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1540350394557-8d14678e7f91?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8N3x8dGFzayUyMG1hbmFnZW1lbnR8ZW58MHx8fHwxNjkzMzQwMjUzfDA&ixlib=rb-4.0.3&q=80&w=500",
      githubUrl: "#",
      liveUrl: "#"
    },
    {
      title: "Healthcare Portal",
      description: "A secure platform for patients to book appointments, access medical records, and communicate with healthcare providers.",
      technologies: ["React", "Express", "MongoDB", "Docker"],
      image: "https://images.unsplash.com/photo-1576091160550-2173dba999ef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3wxMjA3fDB8MXxzZWFyY2h8NXx8aGVhbHRoY2FyZXxlbnwwfHx8fDE2OTMzNDAyOTB8MA&ixlib=rb-4.0.3&q=80&w=500",
      githubUrl: "#",
      liveUrl: "#"
    }
  ];
